...
CREATE TABLE public.aulas (
    ...
    nombreaula character varying(10),
    capacidad integer,
    ubicacion text
);
...
CREATE TABLE public.campus (
    ...
    nombrecampus character varying(100),
    direccioncampus character varying(150)
);
...
CREATE TABLE public.profesores (
    ...
    iddepartamento integer,
    tituloacademico character varying(100)
);
...
ALTER TABLE ONLY public.estudiantescarreras
    ADD CONSTRAINT estudiantescarreras_pkey PRIMARY KEY (idestudiante, idcarrera);
...
ALTER TABLE ONLY public.estudiantes
    ADD CONSTRAINT fk_estudiante_carrera FOREIGN KEY (idcarrera) REFERENCES public.carreras(idcarrera);


--
-- Name: horarios horarios_idaula_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
